...
instance Show (Line Annotations) where
  showsPrec a_a14L (Text.Pulp.Boring b1_a14M)
    = showParen
        ((a_a14L >= 11))
        ((.)
           (showString "Boring ") (showsPrec 11 b1_a14M))
  showsPrec a_a14N (Text.Pulp.HBox b1_a14O b2_a14P)
    = showParen
        ((a_a14N >= 11))
        ((.)
           (showString "HBox ")
  ...
  showsPrec a_a14Q (Text.Pulp.File b1_a14R b2_a14S)
    = showParen
        ((a_a14Q >= 11))
        ((.)
           (showString "File ")
  ...
  showsPrec a_a14Z (Text.Pulp.Unknown b1_a150)
    = showParen
        ((a_a14Z >= 11))
        ((.)
